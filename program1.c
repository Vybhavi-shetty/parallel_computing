//write an OpenMP program to sort an array of n elements using both sequential and parallel merge sort (using the sections directive) record and
//print the difference in execution time between the two methods.
#include<stdio.h>
#include<stdlib.h>
#include<omp.h>
#include<time.h>
